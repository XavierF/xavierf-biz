...
################################################################################
  function bootstrapwp_css_loader() {
    ...
    wp_enqueue_style('flexstyle', get_template_directory_uri().'/css/flexslider.css', false ,'.95', 'all' );
    wp_enqueue_style('style', get_template_directory_uri().'/style.css', false ,'1.0', 'all' );
    wp_enqueue_style('prettify', get_template_directory_uri().'/js/google-code-prettify/prettify.css', false ,'1.5', 'all' );
  }
...
################################################################################
  function bootstrapwp_js_loader() {
       ...
       wp_enqueue_script('flexslider', get_template_directory_uri().'/js/jquery.flexslider-min.js', array('jquery'),'0.90', true );
  }
